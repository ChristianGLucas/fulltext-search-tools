...
https://dev.axiomide.com/marketplace/christiangeorgelucas/fulltext-search-tools@0.1.0
...
```bash
axiom invoke christiangeorgelucas/fulltext-search-tools/Search --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/fulltext-search-tools/0.1.0/Search \
...
> `axiom inspect node christiangeorgelucas/fulltext-search-tools/Search`.
